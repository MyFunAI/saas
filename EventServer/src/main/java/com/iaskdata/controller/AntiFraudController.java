...
/**
 * Anti-fraud algorithms based on belief propagation on markov-random-field-like graphs.
 */
public class AntiFraudController extends Controller implements Prediction{
